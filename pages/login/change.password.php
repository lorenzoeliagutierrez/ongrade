...
<head>
    ...
    <title>Change Password | OnGrade - Bacoor</title>
...
<body class="hold-transition login-page">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md">
                            ...
                            <form action="userData/ctrl.change.password.php" method="POST">
    ...
    } elseif (isset($_SESSION['activation_success'])) {
        echo "<script>
    $(function() {
      toastr.success('Activation code success. Please enter your new password.','Success')
    });
    </script>";
    }
