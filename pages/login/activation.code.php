...
<head>
    ...
    <title>Activation Code | OnGrade - Bacoor</title>
...
<body class="hold-transition login-page">
            ...
            <div class="card-body">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md">
                            <p class="login-box-msg">Enter activation code sent to your email address.</p>
                            <form action="userData/ctrl.activation.code.php" method="POST">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" maxlength="6" min="0" max="6" name="activation_code" placeholder="Activation Code">
    ...
    } elseif (isset($_SESSION['activation_error'])) {
        echo "<script>
    $(function() {
      toastr.error('Password reset confirmation has sent to your email.','Error')
    });
    </script>";
    }
